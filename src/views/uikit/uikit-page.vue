...
import { TNChipsOption } from "@/components/uikit/elements/chips/typings";
import { IAvatarGroupItem } from "@/components/uikit/elements/avatar-group/typings";
import { TNRadioButtonOption } from "@/components/uikit/elements/radio/typings";
import { IHomepageNavFirst } from "@/layouts/homepage-layout/components/header-nav-first/typings";
import { ISignificanceStatuses } from "@/components/uikit/elements/significance/typings";
...
import TnTumbler from "@/components/uikit/elements/tumbler/tn-tumbler.vue";
import TnRadio from "@/components/uikit/elements/radio/tn-radio.vue";
import TnAvatar from "@/components/uikit/elements/avatar/tn-avatar.vue";
import TnAvatarGroup from "@/components/uikit/elements/avatar-group/tn-avatar-group.vue";
...
import TnTextarea from "@/components/uikit/elements/textarea/tn-textarea.vue";
import TnTabs from "@/components/uikit/elements/tabs/tn-tabs.vue";
import TnChips from "@/components/uikit/elements/chips/tn-chips.vue";
import TnNotification from "@/components/uikit/elements/notification/tn-notification.vue";
import TnAlert from "@/components/uikit/elements/alert/tn-alert.vue";
...
import TnSignificanceSelect from "@/components/uikit/elements/significance/tn-significance-select.vue";
